"""DAA Lab Assignment 2 - Problem 2: Sorting Algorithms
Student: SVNIT M.Tech (CSDS103)
Algorithms: Bubble Sort (Early Exit), Selection Sort, Insertion Sort
Input Types: Randomly ordered, Already sorted, Reverse sorted
Sizes: 10 Input Sizes (20, 40, 60, 80, 100, 150, 200, 300, 400, 500)
"""
